...
//         }
        ...
        post {
            success{
                ...
                emailext subject: 'Build Successful', body: 'The build has completed successfully.', attachmentsPattern: 'target/', attachLog: true, to: 'rajeshsuresh230699@gmail.com, rajeshsuresh154@gmail.com'
            }
       }
}
